    ...
    <form action="{{ route('companys.update',$company->id) }}" method="POST">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="branch_code" value="{{ $company->branch_code }}" class="form-control" placeholder="Branch code">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="contact_number" value="{{ $company->contact_number }}"  class="form-control" placeholder="Contact Number">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="text" name="status" value="{{ $company->status }}"  class="form-control" placeholder="Status">
            </div>
        </div>
