<nav class="sidenav navbar 6    z<X-vertical  fixed-left  navbar-expand-xs navbar-light bg-white" id="sidenav-main">
        ...
        <div class="navbar-inner">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    @canany(['view-companys', 'create-companys'])

                        <li class="nav-item">
                            <a class="nav-link {{ (request()->is('companys*')) ? 'active' : '' }}" href="#navbar-companys"  data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-company">
                                <i class="fas text-primary fa-tasks"></i>
                                <span class="nav-link-text">Manage company</span>
                            </a>
                            <div class="collapse" id="navbar-company">
                                <ul class="nav nav-sm flex-column">
                                 @can('view-company')
                                    <li class="nav-item">
                                        <a href="{{route('companys.index')}}" class="nav-link"><span class="sidenav-mini-icon">D </span><span class="sidenav-normal">All company</span></a>
                                    </li>
                                    @endcan
                                    @can( 'create-company')
                                    <li class="nav-item">
                                        <a href="{{route('companys.create')}}" class="nav-link"><span class="sidenav-mini-icon">D </span><span class="sidenav-normal">Add New company</span></a>
                                    </li>
                                    @endcan
                                </ul>
                            </div>
